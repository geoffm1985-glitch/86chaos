...
function Create-UploadZip {
  $zip = Join-Path $script:AppRoot ('86chaos-FULL-SUITE-UPLOAD-ME-16.0.200-' + (Get-Date -Format 'yyyyMMdd-HHmmss') + '.zip')
...
try {
  ...
  Add-PlannedStep 'Source / Static Validation' 'Current targeted validator' 'node scripts/test-16-0-200-targeted.cjs' $true 'node' $false ''
