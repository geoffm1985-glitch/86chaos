'use strict';
const { packAgrees, normalizeUnit, resolveInvoiceQuantity, finiteNumber } = require('./restaurantPack.cjs');
...
module.exports = { normalize, sku, codeFor, descriptionFor, mappingConflicts, mappingIsScoped, suggestInvoiceMatch, buildApprovedMapping };
