...
const foodSafetyShared = { FOOD_SAFETY_CATEGORIES, expectation, evaluateFoodSafety, missedFoodSafetyChecks };

// One implementation for the browser and Node, using the existing shared-helper pattern.
(function publishFoodSafety(root) {
  if (!root) return;
  Object.defineProperty(root, '__86ChaosFoodSafetyShared', {
    value: foodSafetyShared,
    configurable: true,
    writable: true,
  });
