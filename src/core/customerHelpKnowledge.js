...
const CUSTOMER_HELP_VERSION = '16.0.228';
...
const ARTICLES = [
  ...
  article("review-first-contract", "Why 86 Chaos is review-first", "inventory-purchasing", "invoice-review", "Manager / Owner", "AI can extract, explain, research, and recommend. A recommendation is not your approval.", ["why review first", "automatic order", "AI approval"], ["why review first", "automatic order", "AI approval"], [{"title": "How it works", "body": ["Scans cannot change inventory, costs, menu links, or pars until an authorized person approves. AI Order Assistant suggests quantities for review. It does not submit vendor orders or change pars. You retain control over consequential business decisions."]}], [], [], ["invoices"]),
