...
// --- VERSION TRACKING ---
export const CURRENT_VERSION = '14.0.9';
...
// ============================================================================
// 86 CHAOS 14.0.9 ROBUSTNESS ENGINE
...
export const buildV14ClientGuardrailReport = ({ currentVersion = CURRENT_VERSION, features = {}, hasBrandLock = true, hasHelpSearch = true, hasRules = true } = {}) => {
  const checks = [
    { id: 'version', label: 'App version is 14.0.9', ok: currentVersion === '14.0.9', detail: `Running ${currentVersion}` },
