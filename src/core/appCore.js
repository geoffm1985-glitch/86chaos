...
// --- VERSION TRACKING ---
export const CURRENT_VERSION = '14.0.8';
...
// ============================================================================
// 86 CHAOS 14.0.8 ROBUSTNESS ENGINE
...
export const buildV14ClientGuardrailReport = ({ currentVersion = CURRENT_VERSION, features = {}, hasBrandLock = true, hasHelpSearch = true, hasRules = true } = {}) => {
  const checks = [
    { id: 'version', label: 'App version is 14.0.8', ok: currentVersion === '14.0.8', detail: `Running ${currentVersion}` },
