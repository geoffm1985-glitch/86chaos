...
const OPERATIONS_ADDS = [
  ...
  FEATURE_KEYS.BASIC_INVENTORY, FEATURE_KEYS.BURN_LOG, FEATURE_KEYS.BASIC_REPORTS, FEATURE_KEYS.BASIC_AUDIT
];
...
const SMART_KITCHEN_ADDS = [
  ...
  FEATURE_KEYS.MENU_INTELLIGENCE, FEATURE_KEYS.AI_ORDER_ASSISTANT, FEATURE_KEYS.PYTHON_INTELLIGENCE, FEATURE_KEYS.SMART_86_ALERTS, FEATURE_KEYS.DEPENDENCY_TOOLS,
...
export const ROUTE_FEATURES = {
  today: FEATURE_KEYS.BASIC_DASHBOARD,
  ...
  'ai-tools': FEATURE_KEYS.AI_ORDER_ASSISTANT,
