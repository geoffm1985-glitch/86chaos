...
const LoginScreen = ({ setAppUser }) => {
 ...
 email);
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-center justify-center bg-[#05080A] bg-cover bg-center bg-no-repeat relative"
      style={{ backgroundImage: `url('/6136.jpg')` }}
    >
      <div className="absolute inset-0 bg-[#05080A]/78 backdrop-blur-[4px]"></div>
      
      <div className="relative z-10 w-full max-w-sm p-8 bg-[#111821]/94 border border-[#33414B] rounded-3xl shadow-[0_28px_90px_rgba(0,0,0,.55)] flex flex-col items-center animate-[slideIn_0.3s_ease-out]">
        
        <img src="/6139.png" alt="86 Chaos OS Logo" className="h-24 w-auto rounded-xl shadow-lg border border-[#33414B] mb-8 object-contain bg-[#070A0D] p-2" />
        ...
        {pendingUser ? (
          <form onSubmit={handleForcePasswordChange} className="w-full space-y-4 animate-[slideIn_0.2s_ease-out]">
            <div className="text-center mb-4">
              ...
              <p className="text-xs text-[#FFB34D] font-bold mt-1 uppercase tracking-widest">Please set a permanent password.</p>
            </div>
            ...
            <div>
              <input type="password" placeholder="New Password (min 6 chars)" value={newPass} onChange={e => setNewPass(e.target.value)} className="w-full text-center text-lg font-bold bg-[#070A0D] border border-[#33414B] rounded-xl py-4 text-white focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all shadow-inner" required />
            </div>
            <div>
              <input type="password" placeholder="Confirm New Password" value={confirmPass} onChange={e => setConfirmPass(e.target.value)} className="w-full text-center text-lg font-bold bg-[#070A0D] border border-[#33414B] rounded-xl py-4 text-white focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all shadow-inner" required />
            </div>
            
            <button type="submit" className="w-full bg-gradient-to-r from-[#F97316] via-[#F59E0B] to-[#C76712] text-slate-950 font-black tracking-widest uppercase text-lg py-4 rounded-xl shadow-[0_16px_36px_rgba(249,115,22,0.24)] hover:scale-[1.02] transition-all mt-2">
              Save & Enter OS
            </button>
          </form>
        ) : (
          ...
          <form onSubmit={handleLogin} className="w-full space-y-4">
            ...
            <div>
              <input type="text" placeholder="Email Address" value={email} onChange={e => setEmail(e.target.value)} className="w-full text-center text-lg font-bold bg-[#070A0D] border border-[#33414B] rounded-xl py-4 text-white focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all shadow-inner" />
            </div>
     <div>
              <input type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} className="w-full text-center text-lg font-bold bg-[#070A0D] border border-[#33414B] rounded-xl py-4 text-white focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all shadow-inner" />
            </div>

            <label className="flex items-center justify-center gap-2 cursor-pointer mt-2">
              <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-4 h-4 accent-[#F97316] bg-[#070A0D] border border-[#33414B] rounded cursor-pointer" />
              <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Remember Me</span>
            </label>
            
            <button type="submit" className="w-full bg-gradient-to-r from-[#F97316] via-[#F59E0B] to-[#C76712] text-slate-950 font-black tracking-widest uppercase text-lg py-4 rounded-xl shadow-[0_16px_36px_rgba(249,115,22,0.24)] hover:scale-[1.02] transition-all mt-4">
              Unlock System
            </button>
<div className="pt-3 text-center flex flex-col gap-2">
              <button type="button" onClick={handleForgotCredentials} className="text-[10px] font-bold text-slate-500 uppercase tracking-widest hover:text-[#FFB34D] transition-colors">
      ...
      <Modal isOpen={isPrivacyModalOpen} onClose={() => setIsPrivacyModalOpen(false)} title="Privacy Policy">
        <div className="space-y-4 text-xs font-medium text-slate-300 leading-relaxed max-h-[60vh] overflow-y-auto custom-scrollbar pr-2">
          <div className="text-center border-b border-[#33414B] pb-3 mb-3">
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">1. Information We Collect</h4>
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">2. How We Use Your Information</h4>
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">3. Third-Party Data Sharing</h4>
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">4. Employer Control (B2B Clause)</h4>
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">5. Data Security & Retention</h4>
          ...
          <h4 className="font-black text-[#FFB34D] text-sm mt-4">6. Contact Us</h4>
