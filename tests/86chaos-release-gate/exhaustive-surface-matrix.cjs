...
const ROUTE_STATES = {
  ...
  schedule: [
    ['Schedule Builder'],
    ['Open Copilot Tools', 'Coverage'],
    ['Open Copilot Tools', 'Templates'],
    ['Open Copilot Tools', /Create Template|Edit Template/i],
    ['Open Copilot Tools', 'Drag Board'],
    ['Open Copilot Tools', 'Warnings'],
  ...
  'menu-intelligence': [],
  'ai-tools': [],
  prep: [[/line.?check/i], [/daily/i], [/weekly/i], [/monthly/i]],
  recipes: [],
  messages: [],
  reminders: [],
  team: [],
