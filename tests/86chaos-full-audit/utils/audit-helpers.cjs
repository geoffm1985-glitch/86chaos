...
const ROUTE_SPECS = [
  { tab: 'today', label: 'Today / Manager Brief', expect: /Today|Manager Brief|Need Attention|Role Home|Kitchen|Resumen|Inicio de hoy|Necesita atención|Cocina/i },
  { tab: 'ops', label: 'Kitchen Command Center', expect: /Kitchen Command|Command Center|Kitchen/i, optional: true },
  { tab: 'schedule', label: 'Schedule Builder', expect: /Schedule Builder|Auto-Fill|Assign|Publish|Coverage|Schedule|Constructor de horarios|Asignar|Publicar|Cobertura|Horario/i },
  { tab: 'published', label: 'Time Clock / Published Schedule', expect: /Time Clock|My Schedule|Published Schedule|Clock|Reloj|Mi horario|Horario publicado|Fichar/i },
  ...
  { tab: 'prep', label: 'Prep / Tasks / Labels', expect: /Prep|Task|Checklist|Label|Preparación|Tareas|Control de línea|Etiqueta/i },
  ...
  { tab: 'settings', label: 'Settings', expect: /Settings|Preferences|Workspace|Profile|Security|Configuración|Preferencias|Perfil|Seguridad/i },
