...
test.describe('17.1.6 microphone interaction carried forward under 17.1.10 production parity', () => {
  test('86Voice toolbar tap opens the panel and starts the production Web Speech controller', async ({ page }) => {
