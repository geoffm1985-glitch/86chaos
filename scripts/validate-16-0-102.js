...
assert(pkg.version === '16.0.102', 'package.json version is 16.0.102');
assert(versionJson.version === '16.0.102' && versionJson.build === '16.0.102', 'public/version.json version/build are 16.0.102');
