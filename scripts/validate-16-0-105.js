...
assert(pkg.version === '16.0.105', 'package.json version is 16.0.105');
assert(versionJson.version === '16.0.105' && versionJson.build === '16.0.105', 'public/version.json version/build are 16.0.105');
...
assert(firestoreRules.includes('function hasWorkspaceAuthorityFor(restId, a, b, c, d, e, f, g)') && firestoreRules.includes("hasWorkspaceAuthorityFor(restId, 'messageBoard', 'messages', 'team', 'ops'"), 'Firestore rules collapse repeated owner/admin/permission checks into one helper chain');
