...
assert.equal(pkg.scripts['validate:17.0.13'], 'node scripts/validate-17-0-13.js');
...
for (const file of ['src/core/schedulePublicationPlan.js', 'src/core/schedulePublicationPlan.test.js', 'src/features/schedule.jsx', 'tests/86chaos-release-gate/27-pwa-browser-icon-matrix.spec.cjs', 'RELEASE_17_0_13.md']) assert(fs.statSync(file).isFile());
