...
assert(pkg.version === '16.0.115', 'package.json version is 16.0.115');
assert(lock.version === '16.0.115' && lock.packages?.['']?.version === '16.0.115', 'package-lock root versions are 16.0.115');
assert(versionJson.version === '16.0.115' && versionJson.build === '16.0.115', 'public/version.json version/build are 16.0.115');
assert(appCore.includes("export const CURRENT_VERSION = '16.0.115'"), 'src/core/appCore.js CURRENT_VERSION is 16.0.115');
assert(apiVersion.includes("APP_VERSION = '16.0.115'") && apiVersion.includes("SECURITY_SCHEMA_VERSION = '16.0.115'"), 'api/_version.js reports 16.0.115');
