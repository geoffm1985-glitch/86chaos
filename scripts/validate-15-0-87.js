...
mustContain('src/core/appCore.js', "CURRENT_VERSION = '15.0.87'", 'current version 15.0.87');
...
mustContain('public/version.json', '15.0.87', 'public version 15.0.87');
...
console.log('15.0.87 validation passed.');
