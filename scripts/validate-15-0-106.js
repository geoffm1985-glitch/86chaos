...
const checks = [
  ['src/core/appCore.js', /CURRENT_VERSION\s*=\s*'15\.0\.106'/, 'runtime version 15.0.106'],
  ['public/version.json', /15\.0\.106/, 'public version 15.0.106'],
  ['src/features/management.jsx', /system-admin-v106/, 'System Administrator v106 class'],
  ...
  ['src/styles.css', /15\.0\.106 FULL System Administrator content rebuild polish/, 'v106 content rebuild CSS']
];
let failed = false;
...
console.log('15.0.106 System Administrator content rebuild validation passed.');
