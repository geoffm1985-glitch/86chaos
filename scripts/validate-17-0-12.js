...
assert.equal(version.releaseTitle, 'Hostile Certification Source Identity Regression Repair');
...
assert(pkg.scripts['test:repair:17.0.12'].includes('api/firebase-auth-referrer-17-0-11.test.cjs'));
assert(pkg.scripts['test:repair:17.0.12'].includes('api/playwright-progress-17-0-11.test.cjs'));
assert(pkg.scripts['test:repair:17.0.12'].includes('api/release-workflow-17-0-11.test.cjs'));
...
assert(pkg.scripts['test:repair:17.0.12'].includes('api/source-identity-history-17-0-12.test.cjs'));
assert(pkg.scripts['test:repair:17.0.12'].includes('api/repair-17-0-5.test.cjs'));
