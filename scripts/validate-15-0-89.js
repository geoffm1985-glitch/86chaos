...
mustContain('src/core/appCore.js', "CURRENT_VERSION = '15.0.89'", 'current version 15.0.89');
...
mustContain('public/version.json', '15.0.89', 'public version 15.0.89');
...
console.log('15.0.89 validation passed.');
