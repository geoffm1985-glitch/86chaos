...
assert(pkg.version === '16.0.103', 'package.json version is 16.0.103');
assert(versionJson.version === '16.0.103' && versionJson.build === '16.0.103', 'public/version.json version/build are 16.0.103');
