...
const checks = [
  {
    ...
    pass: () => read('src/core/appCore.js').includes("CURRENT_VERSION = '15.0.79'") && JSON.parse(read('public/version.json')).version === '15.0.79' && JSON.parse(read('package.json')).version === '15.0.79'
  },
  {
