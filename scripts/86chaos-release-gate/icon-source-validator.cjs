...
function validateIconSourcePackage(root=process.cwd(), { writeReport = false, reportPath = null } = {}) {
  ...
  for (const required of ['86chaos-icon-192-v1.png','86chaos-icon-512-v1.png','86chaos-maskable-192-v1.png','86chaos-maskable-512-v1.png','86chaos-icon-180-v1.png','favicon.ico']) {
