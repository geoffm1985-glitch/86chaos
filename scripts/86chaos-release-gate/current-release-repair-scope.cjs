...
const CURRENT_RELEASE_VERSION = '17.1.22';
const CURRENT_RELEASE_CARRY_FORWARD_NOTE = '17.1.22 preserves application behavior while repairing Request Off source-test fidelity for the existing i18n-backed All Employees option.';
