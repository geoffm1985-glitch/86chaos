...
const commands = [
  ...
  { group: 'schedule publication module and UI tests', command: 'node scripts/86chaos-release-gate/run-observable-command.cjs --label "Schedule publication module and UI tests" --heartbeat 20 --timeout 900 -- npm run test:schedule-publish', required: true },
