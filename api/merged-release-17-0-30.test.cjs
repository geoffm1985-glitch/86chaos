...
test('17.0.31 keeps 17.0.29 feature-line capabilities', () => {
...
test('17.0.31 carries forward 16.0.244 safety and release-gate repairs', () => {
...
test('17.0.31 schedule PDF combines compact month view and lossless dense overflow', () => {
