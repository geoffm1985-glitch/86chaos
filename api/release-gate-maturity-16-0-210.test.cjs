...
test('16.0.210 historical maturity assertions coexist with current 17.0.5 version metadata', () => {
  ...
  assert.equal(version.releaseTitle, 'Schedule Role Reconciliation and Release Gate Repair');
