...
test('16.0.210 historical maturity assertions coexist with current 17.0.32 version metadata', () => {
  ...
  assert.match(appCore, /CURRENT_VERSION = '17\.0\.32'/);
  assert.match(apiVersion, /APP_VERSION = '17\.0\.32'/);
  assert.match(apiVersion, /SECURITY_SCHEMA_VERSION = '17\.0\.32'/);
});
