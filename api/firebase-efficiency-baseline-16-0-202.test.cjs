...
test('16.0.202 trims only low-risk Today demand and preserves full feature caps', () => {
...
test('16.0.202 gates HR heavy datasets by visible section and uses count-first overview', () => {
...
test('16.0.202 keeps diagnostics and no-op write protection but does not touch Firebase frozen files', () => {
