...
test('16.0.208 historical maturity assertions coexist with current 17.0.12 version metadata', () => {
  ...
  assert.match(apiVersion, /APP_VERSION = '17.0.12'/);
  assert.match(apiVersion, /SECURITY_SCHEMA_VERSION = '17.0.12'/);
  assert.match(appCore, /CURRENT_VERSION = '17.0.12'/);
});
