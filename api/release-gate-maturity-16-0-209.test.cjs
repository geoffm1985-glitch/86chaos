...
test('16.0.209 historical maturity assertions coexist with current 17.0.15 version metadata', () => {
  ...
  assert.match(appCore, /CURRENT_VERSION = '17.0.15'/);
  assert.match(apiVersion, /APP_VERSION = '17.0.15'/);
});
