...
test('16.0.209 historical maturity assertions coexist with current 17.0.23 version metadata', () => {
  ...
  assert.match(appCore, /CURRENT_VERSION = '17.0.23'/);
  assert.match(apiVersion, /APP_VERSION = '17.0.23'/);
});
