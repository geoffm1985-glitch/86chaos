...
$env:CHAOS_COST_SCENARIO_REPORT_DIR = Join-Path $RunDir 'cost-scenarios'
$env:CHAOS_COST_EXPECTED_RUN_ID = $RunId
$env:CHAOS_COST_EXPECTED_FIREBASE_PROJECT_ID = 'chaos-test-d1601'
$env:CHAOS_COST_EXPECTED_VERSION = $env:CHAOS_EXPECTED_VERSION
